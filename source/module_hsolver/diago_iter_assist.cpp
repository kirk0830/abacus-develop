...
void DiagoIterAssist<FPTYPE, Device>::diagH_subspace(
    hamilt::Hamilt<FPTYPE, Device>* pHamilt, // hamiltonian operator carrier
    const psi::Psi<std::complex<FPTYPE>, Device> &psi, // [in] wavefunction
    psi::Psi<std::complex<FPTYPE>, Device> &evc, // [out] wavefunction
    FPTYPE *en, // [out] eigenvalues
